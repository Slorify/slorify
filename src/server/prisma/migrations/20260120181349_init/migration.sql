...
INSERT INTO "new_GithubApp" ("app_id", "client_id", "client_secret", "createdAt", "id", "name", "owner_login", "private_key", "slug", "url", "userId", "webhook_secret") SELECT "app_id", "client_id", "client_secret", "createdAt", "id", "name", "owner_login", "private_key", "slug", "url", "userId", "webhook_secret" FROM "GithubApp";
